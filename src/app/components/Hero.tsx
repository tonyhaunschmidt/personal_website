...
export default function Hero() {
  return (
    <div className="h-screen w-full flex min-h-96 flex-col items-center justify-center">
      <div className="text-center">
        <h1 className="font-black text-3xl sm:text-4xl leading-none">
          TONY HAUNSCHMIDT
        </h1>
        <p className="text-primary font-medium mt-1 sm:text-lg tracking-widest sm:tracking-[0.6rem] leading-none">
          SOFTWARE ENGINEER
        </p>
      </div>
